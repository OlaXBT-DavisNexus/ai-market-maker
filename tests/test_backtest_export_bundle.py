...
class TestWriteEquityCsv:
    def test_headers_and_drawdown(self):
        ...
        snapshots = [
            {"ts": 1700000000000, "capital": 10000.0, "unrealized_pnl": 0.0, "equity": 10000.0, "position_count": 0},
            {"ts": 1700000001000, "capital": 10050.0, "unrealized_pnl": 100.0, "equity": 10150.0, "position_count": 1},
            {"ts": 1700000002000, "capital": 9800.0, "unrealized_pnl": -50.0, "equity": 9750.0, "position_count": 1},
        ]
...
class TestWriteAnalysisBundle:
    def test_all_files_created(self):
        ...
        snapshots = [{"ts": 1700000000000, "capital": 10000, "unrealized_pnl": 0, "equity": 10000, "position_count": 0}]
